...
LG 그룹 디자인 컨벤션을 따르는 PPTX 자동 생성 스킬 (에이투지체 폰트)
...
- 에이투지체 폰트 + 한국어/영어 완벽 지원
- `python-pptx` 기반, 16:9 와이드스크린

## Install

```bash
npx @anthropic-ai/claude-code skills add Ohkyusung/lg-pptx-skill
```
...
- **에이투지체 (A2Z)**: https://freesentation.blog/a2z
- 라이선스: SIL OFL (무료)
